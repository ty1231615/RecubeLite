...
class PositionKeyFrame(Task):
    def __init__(self, fromPosition:Pos, targetPosition:Pos, valueSetter: types.FunctionType, taskType, delay=Progress(0,0,0,1), easing_format: types.FunctionType = easing.no_easing, repeat=Progress(0,0,0,1), repeatDelay=Progress(0,0,0,1), complete = False):
